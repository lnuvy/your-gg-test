      ...
      <div className="flex-c-c" style={{ width: '100%', padding: '2rem' }}>
        ...
        <OtherWords className="flex-c-center">
          <div>
            ...
            지원한 곳 중에서 가장 취업하고 싶었던 곳에서 서류합격을 받아 너무 기쁜 마음으로 즐겁게 코딩했습니다. <br />
            어딘가 엉성하고, 기술적으로 부족한 점도 많았고, 클린코드도 아니겠지만 제가 할 수 있는 최선을 다했습니다.
            잘부탁드립니다!
          </div>
          <span>사용한 라이브러리: axios, react-query, @emotion, chart.js, react-chartjs-2, dayjs</span>
        </OtherWords>
      </div>
    </div>
  )
